...
│                                                              │
│  ┌────────────┐  ┌─────────┐  ┌────────────┐  ┌──────────┐  ┌──────────────┐ │
│  │ Pi Adapter │  │   CLI   │  │MCP Server  │  │  Daemon  │  │ Cline Plugin │ │
│  │   532L     │  │  303L   │  │   221L     │  │   334L   │  │    380L      │ │
│  └─────┬──────┘  └────┬────┘  └─────┬──────┘  └────┬─────┘  └──────┬───────┘ │
│        │              │              │               │       │
│        └──────────────┴──────┬───────┴───────────────┘       │
│                              │                               │
...
│   │
│   ├── extensions/             # Plugin adapters
│   │   ├── pi/                 # Pi extension adapter
│   │   │   └── adapter.ts      (532)  Pi ExtensionAPI wrapper
│   │   └── cline/              # Cline plugin adapter (v2)
│   │       ├── adapter.ts      (380)  AgentPlugin + tools + rules + hooks
│   │       └── plugin.ts       (8)    Entry point
│   │
